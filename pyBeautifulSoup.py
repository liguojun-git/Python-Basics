...
# .find_all_next()	        查找当前标签后所有符合条件的标签。	                            ags = soup.find('div').find_all_next('p')
...
# .parent	                        获取标签的父元素。	                            arent = tag.parent
# 其他
# 方法/属性	                                描述	                                    示例
