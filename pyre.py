...
# 为什么使用 re 模块？
# 在处理文本时，我们经常需要查找特定的模式或替换某些字符。例如，验证电子邮件地址、提取网页中的链接、或者格式化文本。
# 手动编写代码来完成这些任务可能会非常繁琐，而正则表达式提供了一种简洁且高效的方式来解决这些问题。
...
# re.match()	从字符串开头匹配	开头不匹配就失败 ❌
# re.search()	任意位置匹配	    只要找到就成功 ✅
...
# re.escape()	                    转义特殊字符	                             re.escape("C:\\Users\\test.txt")
