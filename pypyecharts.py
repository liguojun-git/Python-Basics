...
bar_chart.render("pyecharts1.html")
...
# 渲染图表
bar_chart.render("pyecharts2.html")
...
bar_chart = Bar(init_opts=opts.InitOpts(theme=ThemeType.WALDEN))  # 初始主题为亮色系
bar_chart.add_xaxis(x_data)
bar_chart.add_yaxis("销售额", y_data)
...
# 渲染图表
bar_chart.render("pyecharts3.html")
...
# 渲染图表
bar_chart.render("pyecharts4.html")
