...
# x	            窗口左上角距离屏幕左边的距离	  100 像素
# y	            窗口左上角距离屏幕顶部的距离	  100 像素
# width	        窗口的宽度	                    400 像素
# height	    窗口的高度	                    300 像素
...
# 用途	            基础窗口/控件容器	                    完整的主窗口框架
# 菜单栏	            ❌ 没有	                            ✅ 有
# 工具栏	            ❌ 没有	                            ✅ 有
# 状态栏	            ❌ 没有	                            ✅ 有
# 中央区域	            ❌ 没有	                            ✅ 有（central widget）
# 布局方式	            直接添加控件	                    必须设置 central widget
# 使用场景	        对话框、小组件、自定义控件	                主程序窗口
...
textbox.move(100, 50)
# textbox.resize(200, 30)  # 宽度200，高度30
...
""" class MainWindow(QMainWindow):
    def __init__(self):
        ...
        # ===== 3. 在中心控件上设置布局 =====
        central_widget.setLayout(layout)  # ✅ 只保留这一行
